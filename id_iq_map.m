...
mode_d = round(cos(((Input.mode_m-1)*90+45)/180*pi)*sqrt(2));      % d-q plane에서 사분면 구분하기 위한 뱡향벡터
mode_q = round(sin(((Input.mode_m-1)*90+45)/180*pi)*sqrt(2));      % d-q plane에서 사분면 구분하기 위한 뱡향벡터
